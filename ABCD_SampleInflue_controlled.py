...
# The script is comparable to ABCD_ROCAUC_Comparison_controlled.py, but additionally iterates over different sample sizes and subsequently plots the results in a bubble plot.
# This scripts results in Figure S2 in the supplements.
...
# check out ABCD_ROCAUC_Comparison_controlled.py for more detailed comments
...
s1 = sns.scatterplot(data=df_fa, x="mean_same", y="iqr_same", hue="Harmonization", size="N", sizes=(250, 25), ax=axs[0, 0],
                legend=False, palette="magma", edgecolor="white", linewidth=1, alpha=0.7)

s2= sns.scatterplot(data=df_md, x="mean_same", y="iqr_same", hue="Harmonization", size="N", sizes=(250, 25), ax=axs[1, 0],
                legend="auto", palette="magma", edgecolor="white", linewidth=1, alpha=0.7)
...
legend.get_texts()[5].set_text("N:")

#plt.show()

fig.savefig(join(path,"ABCD_Relief_FigS2_revised.png"), dpi=300, bbox_inches="tight")
fig.savefig(join(path,"ABCD_Relief_FigS2_revised.pdf"), bbox_inches="tight")