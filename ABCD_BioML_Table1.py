# Description: This script is used to test whether Combat and Relief Harmonization preserve the biological signal in the data (i.e., signal from the covariates)
# We deploy a simple Machine Learning Framework to predict covariates from raw, Combat, and Relief data - and compare the performance of the three methods.
# Result of this script is depicted in Table 1 in the manuscript.
